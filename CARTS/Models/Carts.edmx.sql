...
-- --------------------------------------------------
-- Date Created: 11/13/2019 16:22:10
-- Generated from EDMX file: F:\MVC shopping cart\CARTS\Models\Carts.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[CartsModelStoreContainer].[ProductCommets]', 'U') IS NOT NULL
    DROP TABLE [CartsModelStoreContainer].[ProductCommets];
GO
